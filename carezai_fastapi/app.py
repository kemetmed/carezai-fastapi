...
description = """
carezai_fastapi API helps you do awesome stuff. 🚀
"""

app = FastAPI(
    title="carezai_fastapi",
    description=description,
    version=read("VERSION"),
    terms_of_service="http://carezai_fastapi.com/terms/",
    contact={
        "name": "kemetmed",
        "url": "http://carezai_fastapi.com/contact/",
        "email": "kemetmed@carezai_fastapi.com",
    },
    license_info={
        "name": "The Unlicense",
