...
# WARNING: Ensure imports from `carezai_fastapi` comes after this line
from carezai_fastapi import app, settings, db  # noqa
from carezai_fastapi.cli import create_user, cli  # noqa
